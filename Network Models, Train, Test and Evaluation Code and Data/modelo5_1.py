...
* NIA: 755224
* FICHERO : modelo5_1.py
* FECHA : Mayo de 2021
* DESCRIPCION: Modelo 4: version del modelo base con dimensiones variables mediante dos parámetros: los canales de partida y 
               un factor de crecimiento. Se consideran las clases concurrentes. Entrenado con el subset de 4 patologías ampliado.
"""
# Modelo 4: version del modelo base con dimensiones variables mediante dos parámetros: los canales de partida y un factor de crecimiento.
# Se consideran las clases concurrentes
...
# Modelo de dimensiones variables, para el subset de 4 patologías ampliado      Batch de dimensiones 32x15x10x750
import numpy as np
...
if not hay_ficheros:
  ...
  file = open('/home/alumnos/alumno5/work/Modelos/modelo5_canales/validacion.txt', 'wb')
  pickle.dump(validacion, file)
  file.close()
  file = open('/home/alumnos/alumno5/work/Modelos/modelo5_canales/test.txt', 'wb')
  pickle.dump(x_test, file)
  file.close()
  file = open('/home/alumnos/alumno5/work/Modelos/modelo5_canales/train.txt', 'wb')
...
plt.xlabel('Epoch')
plt.ylabel('Coste')
plt.savefig('/home/alumnos/alumno5/work/Modelos/modelo5_canales/costes_3_20ep.png')
plt.close()
