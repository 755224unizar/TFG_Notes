...
* NIA: 755224
* FICHERO : modelo4_lin3_1.py
* FECHA : Mayo de 2021
* DESCRIPCION: Modelo 2: modelo que parte del modelo base y añade una capa lineal más al final de las ya existentes, 
               se considera la posible concurrencia de las clases. Entrenado con el subset de 4 patologías ampliado.
"""
# Modelo 2: modelo que parte del modelo base y añade una capa lineal más al final de las ya existentes, se considera la posible concurrencia
# de las clases.
...
# Modelo con una capa lineal más, para el subset de 4 patologías ampliado.      Batch de dimensiones 32x15x10x750
import numpy as np
...
path = '/home/alumnos/alumno5/work/Modelos/modelo4_capas/modelo4_lin3_1_20ep.pt'
...
plt.xlabel('Epoch')
plt.ylabel('Coste')
plt.savefig('/home/alumnos/alumno5/work/Modelos/modelo4_capas/lin3_1/costes_20ep.png')
plt.close()
